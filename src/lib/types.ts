...
// HTTP Header Names enum (based on Axios CommonRequestHeadersList and common headers)
enum HTTPHeader {
  // Content headers
...
// HTTP Content Types enum (based on Axios ContentType)
enum ContentType {
...
enum HTTPStatusCodes {
   ...
   */
  INSUFFICIENT_SPACE_ON_RESOURCE_419 = 419,
  /**
   * @deprecated
...
export { ContentType, AcceptType, HTTPHeader, HTTPStatusCodes, HTTPMethod }
